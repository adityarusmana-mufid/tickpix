...
import type { Block, Activity, Goal, Bleed } from '../types'
import { Button } from '@/components/ui/pixelact-ui/button'
import ActivityList from './ActivityList'
import BlockEditor from './BlockEditor'
import ScheduleList from './ScheduleList'
import GoalsTab from './GoalsTab'
import BleedsTab from './BleedsTab'
...
const TABS = [
  ...
  { icon: 'M2 5h2v4H2zm20 0h-2v4h2zM4 9h2v2H4zm16 0h-2v2h2zM2 13h4v2H2zm20 0h-4v2h4zM4 17h2v2H4zm16 0h-2v2h2zM2 19h2v2H2zm20 0h-2v2h2zM6 11h12v2H6zM6 7h2v12H6zm10 0h2v12h-2zM8 19h8v2H8zM8 5h8v2H8zM11 15h2v6h-2zM8 1h2v6H8zm6 0h2v6h-2z', label: 'Bleed' },
]
